// ─── Simulated data for TransportConnect Angola Dashboard ───
...
export const REVENUE_BY_LINE = [
  { linha: 'TC L01', receita: 145, eficiencia: 87, passageiros: 2400 },
  { linha: 'TC L02', receita: 138, eficiencia: 82, passageiros: 1800 },
  { linha: 'MT-A', receita: 163, eficiencia: 91, passageiros: 3100 },
  { linha: 'MT-B', receita: 98, eficiencia: 74, passageiros: 1100 },
  { linha: 'TC L03', receita: 118, eficiencia: 79, passageiros: 1600 },
];
...
export const HEATMAP_REGIONS = [
  { region: 'Baixa / Ingombotas', level: 95 },
  { region: 'Bairro Operário', level: 88 },
  { region: 'Av. Deolinda Rodrigues', level: 82 },
  { region: 'Kinaxixi', level: 71 },
  { region: 'Alvalade', level: 65 },
  { region: 'Maianga', level: 58 },
  { region: 'Viana', level: 42 },
  { region: 'Talatona', level: 35 },
];
...
export const INCIDENTS = [
  {
    ...
    severity: 'high',
    description:
      'Acidente com 2 veículos, bloqueio parcial da via sentido Bairro Operário',
  },
  {
    id: 'INC-002',
    type: 'congestion',
    ...
    severity: 'medium',
    description:
      'Congestionamento intenso sentido Baixa, tempo de espera ~30 min',
  },
  {
    id: 'INC-003',
    type: 'maintenance',
    ...
    severity: 'low',
    description: 'Buraco no asfalto junto ao Hub Viana, risco para moto-táxis',
  },
  {
    id: 'INC-004',
    type: 'flood',
    ...
    severity: 'high',
    description:
      'Alagamento após chuvas fortes, estrada parcialmente intransitável',
  },
  {
    id: 'INC-005',
    type: 'other',
...
export const AI_SUGGESTIONS = [
  {
    ...
    type: 'new_route',
    emoji: '🛣️',
    title: 'Nova Rota: Luanda Sul ↔ Aeroporto',
    confidence: 89,
  ...
  },
  {
    ...
    type: 'frequency',
    emoji: '⚡',
    title: 'Aumentar Frequência: TC L01 em Hora de Pico',
    confidence: 94,
    impact: 'high' as const,
  ...
  },
  {
    ...
    type: 'infrastructure',
    emoji: '🏗️',
    title: 'Novo Hub Logístico: Bairro Rocha Pinto',
    confidence: 76,
...
export const LUANDA_LOCATIONS = [
  'Terminal do Maculusso',
  'Baixa de Luanda',
  'Ingombotas',
  'Maianga',
  'Kinaxixi',
